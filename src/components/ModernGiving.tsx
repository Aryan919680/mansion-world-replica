export const ModernGiving = () => {
  return (
    <section className="px-4 py-12 md:py-16 text-black">
      <div className="w-full max-w-[400px] md:w-[400px] mx-auto text-center">
        <h2 className="lg:text-[18px] md:text-[24px] font-heading mb-4 md:mb-6">Modern Giving</h2>
        <p className="lg:text-[13px] md:text-[18px] leading-relaxed">
